        ...
        <div>
            ...
            <table class="service-table">
                ...
                <tr>
                    ...
                    <td>WeatherData[]</td>
                    <td>Returns 7-day weather forecast for given zip code</td>
                ...
                <tr>
                    ...
                    <td>double</td>
                    <td>Converts temperature between Fahrenheit and Celsius</td>
                ...
                <tr>
                    ...
                    <td>location (string), date (DateTime)</td>
                    <td>string[]</td>
                    <td>Returns activity suggestions for rainy days</td>
                ...
                <tr>
                    ...
                    <td>data (string)</td>
                    <td>string</td>
                    <td>Encrypts sensitive user data using AES encryption</td>
                ...
                <tr>
                    ...
                    <td>void</td>
                    <td>Displays weather information in formatted view</td>
                ...
                <tr>
                    ...
                    <td>-</td>
                    <td>void</td>
                    <td>Initializes weather cache on application start</td>
                    <td>N/A</td>
                </tr>
                <tr>
                    <td>Team Member 2</td>
                    ...
                    <td>void</td>
                    <td>Stores user preferences for temperature units and locations</td>
            ...
            <div class="try-it-panel">
                <asp:MultiView ID="mvTryIt" runat="server" ActiveViewIndex="0">
                    ...
                    <asp:View ID="vwForecast" runat="server">
                        ...
                        <br /><br />
                        <asp:Label ID="lblForecastResult" runat="server"></asp:Label>
                    </asp:View>
                    ...
                    <asp:View ID="vwEncryption" runat="server">
                        ...
                        <asp:TextBox ID="txtPlainText" runat="server"></asp:TextBox>
                    ...
                    <asp:View ID="vwUserControl" runat="server">
                        ...
                        <p>The weather display control will be demonstrated here.</p>
                        <!-- User control will be added here -->
                    </asp:View>
                    ...
                    <asp:View ID="vwCookie" runat="server">
                        ...
                        <asp:TextBox ID="txtPrefLocation" runat="server"></asp:TextBox>
                        <br />
                        ...
                        <br /><br />
                        <asp:Label ID="lblCookieResult" runat="server"></asp:Label>
                    </asp:View>
                </asp:MultiView>
            </div>
            
            <div class="button-panel">
                <h3>Access Control (For Assignment 6)</h3>
